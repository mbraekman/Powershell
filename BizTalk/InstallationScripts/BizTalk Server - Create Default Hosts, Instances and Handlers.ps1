...
#############################################################
# This function will update an existing BizTalk Host
...
#############################################################
# This function will delete an existing host handler 
# in the adapters.
...
function ConfiguringBizTalkServerHostAndHostInstances
{
	...
	[string]$receiveHostName = 'BizTalkReceive'  
	[string]$sendHostName = 'BizTalkSend'
	[string]$processingHostName = 'BizTalkProcess' # use this to create another processing host
	[string]$trackingHostName = 'BizTalkTracking'
	# Note: why we need to create 32bits hosts? FTP, POP3 and SQL doesn't support 64bits 
	[string]$receive32HostName = 'BizTalkReceive32'
	[string]$send32HostName = 'BizTalkSend32'

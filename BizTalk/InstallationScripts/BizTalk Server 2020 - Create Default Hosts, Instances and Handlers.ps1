...
function ConfiguringBizTalkServerHostAndHostInstances
{
	...
	[string]$receiveHostName = 'Receive_Host'
	[string]$sendHostName = 'Send_Host'
	[string]$processingHostName = 'Processing_Host' # use this to create another processing host
	[string]$trackingHostName = 'Tracking_Host'
	# Note: why we need to create 32bits hosts? FTP, POP3 and SQL doesn't support 64bits 
	[string]$receive32HostName = 'Receive32_Host'
	[string]$send32HostName = 'Send32_Host'

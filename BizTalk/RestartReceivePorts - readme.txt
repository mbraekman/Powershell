...
This script allows for you to automate the enabling of all the receive locations for a specific application.
...
The script can be configured using the variables on the first 3 lines:
 ...
 - $DBName:
   ...
   i.e.  BizTalkMgmtDb
 - $Application:
   The name of the application for which the receive locations should be enabled.

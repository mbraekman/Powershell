...
Set-AzureKeyVaultSecret -VaultName $keyVaultName -SecretName $secretName -SecretValue (ConvertTo-SecureString (Get-Content $filePath -Raw) -force -AsPlainText ) -ErrorAction Stop
